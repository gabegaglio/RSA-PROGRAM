...
string decrypt(vector<long long>& blocks, long long d, long long n) {
    string message = "";
...
int main() {
    ...
    // Keys from RSA-Class main.cpp
    long long privKey = 317105;
    long long mod = 13321;  // The actual modulus in RSA-Class
    
    cout << "=== DECRYPTING WITH RSA-CLASS KEYS ===" << endl;
    cout << "Using d=" << privKey << ", n=" << mod << endl << endl;
    
    cout << "Message:" << endl;
    string message = decrypt(encryptedMsg, privKey, mod);
    cout << "Decrypted: \"" << message << "\"" << endl << endl;
    
    cout << "Signature:" << endl;
    string signature = decrypt(encryptedSig, privKey, mod);
